...
(function () {
    ...
    const I18N = {
        en: {
            ...
            'cta.eyebrow': 'Experience Safety Digi',
            'cta.title': 'Ready to Transform Your Site Safety?',
            'cta.sub': 'Join leading HSE teams who have eliminated manual paperwork, digitized checklists, and reduced incident response times by 40%.',
            'cta.f1.t': 'Setup in Minutes',
            'cta.f1.d': 'Zero complicated training needed. Import your existing checklists instantly.',
            'cta.f2.t': 'Automated HSE Reports',
            'cta.f2.d': 'Daily field logs are automatically rolled into beautiful, printable monthly reports.',
            'cta.f3.t': 'ISO-Aligned Security',
            'cta.f3.d': 'Built on secure, enterprise-grade cloud servers aligned with ISO 45001 standards.',
            'cta.ctaBtn': 'Request 30-Day Free Trial',
            'cta.exploreBtn': 'Watch Video Demo',
        ...
        ar: {
            ...
            'cta.eyebrow': 'جرّب سيفتي ديجي',
            'cta.title': 'هل أنت مستعد للارتقاء بسلامة موقعك؟',
            'cta.sub': 'انضم إلى فرق الصحة والسلامة والبيئة الرائدة التي تخلصت من المعاملات الورقية اليدوية، وحوّلت قوائم التفتيش إلى رقمية، وقللت من أوقات الاستجابة للحوادث بنسبة 40%.',
            'cta.f1.t': 'الإعداد في دقائق',
            'cta.f1.d': 'لا حاجة لتدريبات معقدة. قم باستيراد قوائم التفتيش الحالية الخاصة بك على الفور.',
            'cta.f2.t': 'تقارير الصحة والسلامة التلقائية',
            'cta.f2.d': 'يتم دمج سجلات العمل الميداني اليومية تلقائيًا في تقارير شهرية جميلة وقابلة للطباعة.',
            'cta.f3.t': 'أمان متوافق مع معايير ISO',
            'cta.f3.d': 'مبني على خوادم سحابية آمنة ومخصصة للمؤسسات متوافقة مع معيار ISO 45001.',
            'cta.ctaBtn': 'طلب تجربة مجانية لمدة 30 يومًا',
            'cta.exploreBtn': 'شاهد عرض الفيديو',
